  ...
  render: function(context, firstTime) {
    ...
    if (firstTime) {
      ...
      for(idx=0;idx<itemsLength;idx++) {
        ...
        icon = item[3];
        if (icon) {
          url = (icon.indexOf('/')>=0) ? icon : '/static/sproutcore/desktop/en/current/images/blank.gif?1241712509';
        ...
        var blankImage = '/static/sproutcore/desktop/en/current/images/blank.gif?1241712509';
